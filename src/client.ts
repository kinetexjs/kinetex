...
export class Kinetex {
  ...
  async sse(
    ...
    const pipeFetch: typeof fetch = async (input, init) => {
      ...
      const rawRes = await this.send<Uint8Array>(reqUrl, (init?.method ?? "GET") as HTTPMethod, {
  ...
  async graphql(
    ...
    const pipeFetch: typeof fetch = async (input, init) => {
      const reqUrl = typeof input === "string" ? input : (input as Request).url;
      const rawRes = await this.send<unknown>(reqUrl, (init?.method ?? "POST") as HTTPMethod, {
        headers: init?.headers as Record<string, string>,
        body: init?.body as BodyInit,
        signal: init?.signal as AbortSignal,
        throwOnError: false,
  ...
  async paginate<T>(
    ...
    const pipeFetch: typeof fetch = async (input, init) => {
      const reqUrl = typeof input === "string" ? input : (input as Request).url;
      const rawRes = await this.send<unknown>(reqUrl, (init?.method ?? "GET") as HTTPMethod, {
        headers: init?.headers as Record<string, string>,
        body: init?.body as BodyInit,
        signal: init?.signal as AbortSignal,
        throwOnError: false,
